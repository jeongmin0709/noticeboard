...
## 마치며
  ...
  테스트코드를 작성하고 확인하니 눈에 잘뛰지 않았던 문제점이나 실수한 부분을 많이 고칠수 있었습니다. 개발시간도 많이 줄어드는것도 느낄수 있었습니다.  
  두번쨰로는 어떤설계가 더좋은 설계인지 많은 생각을 할 수 있었습니다. 모듈간의 결합도를 낮추기위해 어떻게하는게 좋은지, 예외를 어떤상황에 발생시키고 어떻게 처리를 할지 등등 많은 생각을 하게 하였습니다. 결합도 부분에서는 결합도가 높은
  ...
  이번 프로젝트는 저에게 많은 도움을 주었고 발전할 방향을 알려주는 프로젝트가 되었던것 같습니다. 긴글 읽어주셔서 감사합니다.
